...
rule SDBFile
{
	meta:
 	...
 	condition:
 		$magic at 8 and
		pe.imphash() != "B02B4B8924F019BDE57484A55DC5CA57" and
		pe.imphash() != "BA17F2DA98A8A375D22CB33C8E83A146" and
		pe.imphash() != "EC9D5F0AE38EC4A97E70960264B7D07D" and
		pe.imphash() != "4C7B2F691885878EDBAE48760A7E3FB9" and
		pe.imphash() != "1D8C1280D38C526C7041E72DB8D70DC1" and
		pe.imphash() != "8006552125C9D590843192543668BB0B"
}
